...
class Library:
    ...
    def _init_sample_data(self):
        sample_books = [
            ...
            Book("百年孤独", "加西亚·马尔克斯", "978-7-5442-5399-1", "南海出版公司", "2011-06-01", "文学"),
            Book("Python编程：从入门到实践", "Eric Matthes", "978-7-115-42986-5", "人民邮电出版社", "2016-07-01",
                 "编程"),
            Book("流畅的Python", "Luciano Ramalho", "978-7-115-45678-9", "人民邮电出版社", "2017-05-01", "编程"),
            Book("算法导论", "Thomas H. Cormen", "978-7-111-23461-6", "机械工业出版社", "2013-01-01", "编程"),
            Book("深入理解计算机系统", "Randal E. Bryant", "978-7-111-33594-6", "机械工业出版社", "2016-12-01", "编程"),
            Book("人类简史", "尤瓦尔·赫拉利", "978-7-5086-6097-6", "中信出版社", "2017-02-01", "历史"),
            Book("未来简史", "尤瓦尔·赫拉利", "978-7-5086-7206-1", "中信出版社", "2017-06-01", "历史"),
            Book("时间简史", "史蒂芬·霍金", "978-7-5357-3230-3", "湖南科学技术出版社", "2010-04-01", "科学"),
            Book("思考，快与慢", "丹尼尔·卡尼曼", "978-7-5086-3355-0", "中信出版社", "2012-07-01", "心理"),
            Book("乌合之众", "古斯塔夫·勒庞", "978-7-5113-4303-5", "中国华侨出版社", "2016-01-01", "心理"),
            Book("国富论", "亚当·斯密", "978-7-121-23456-7", "商务印书馆", "2015-03-01", "经济"),
            Book("原则", "瑞·达利欧", "978-7-5086-9130-7", "中信出版社", "2018-01-01", "管理"),
        ]
        self.books = sample_books

        sample_readers = [
            Reader("20240001", "陈明远", "男", "13812345678", "chenmingyuan@email.com", "北京市海淀区中关村大街1号"),
            Reader("20240002", "林婉清", "女", "13987654321", "linwanqing@email.com", "上海市浦东新区世纪大道100号"),
            Reader("20240003", "张书豪", "男", "18612345678", "zhangshuhao@email.com", "广州市天河区珠江新城15号"),
            Reader("20240004", "赵雨桐", "女", "15987654321", "zhaoyutong@email.com", "深圳市南山区科技园10号"),
            Reader("20240005", "周泽洋", "男", "18812345678", "zhouzeyang@email.com", "杭州市西湖区文三路20号"),
            Reader("20240006", "吴思琪", "女", "15012345678", "wusiqi@email.com", "成都市武侯区天府大道5号"),
        ]
